...
MODULE shr_const_mod
   ...
   real(R8),parameter :: SHR_CONST_BOLTZ = 1.38065e-23_R8 ! Boltzmann constant ~ J/K/molecule
   real(R8),parameter :: SHR_CONST_AVOGAD = 6.02214e26_R8 ! Avogadro number ~ molecules/kmole
