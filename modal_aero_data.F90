...
#elif ( defined MODAL_AERO_7MODE )
    real(r8), parameter :: dgnum_amode(ntot_amode)   = (/ 0.1100e-6_r8, 0.0260e-6_r8, 0.050e-6_r8, 0.200e-6_r8, 0.100e-6_r8, 2.000e-6_r8, 1.000e-6_r8 /)
    real(r8), parameter :: dgnumlo_amode(ntot_amode) = (/ 0.0535e-6_r8, 0.0087e-6_r8, 0.010e-6_r8, 0.050e-6_r8, 0.050e-6_r8, 1.000e-6_r8, 0.500e-6_r8 /)
    real(r8), parameter :: dgnumhi_amode(ntot_amode) = (/ 0.4400e-6_r8, 0.0520e-6_r8, 0.100e-6_r8, 1.000e-6_r8, 0.500e-6_r8, 4.000e-6_r8, 2.000e-6_r8 /)
#elif ( defined MODAL_AERO_3MODE )
    real(r8), parameter ::     dgnum_amode(ntot_amode)   = (/ 0.1100e-6_r8, 0.0260e-6_r8, 2.000e-6_r8 /)
    real(r8), parameter ::     dgnumlo_amode(ntot_amode) = (/ 0.0535e-6_r8, 0.0087e-6_r8, 1.000e-6_r8 /)
    real(r8), parameter ::     dgnumhi_amode(ntot_amode) = (/ 0.4400e-6_r8, 0.0520e-6_r8, 4.000e-6_r8 /)
#endif
...
#elif ( defined MODAL_AERO_7MODE )
    real(r8), parameter ::     sigmag_amode(ntot_amode)   = (/ 1.800_r8, 1.600_r8, 1.600_r8, 2.000_r8, 1.800_r8, 2.000_r8, 1.800_r8 /)
#elif ( defined MODAL_AERO_3MODE )
    real(r8), parameter ::     sigmag_amode(ntot_amode)   = (/ 1.800_r8, 1.600_r8, 1.800_r8 /)
#endif
...
#elif ( defined MODAL_AERO_7MODE )
    real(r8), parameter ::     rhcrystal_amode(ntot_amode)  = (/ 0.350_r8, 0.350_r8, 0.350_r8, 0.350_r8, 0.350_r8, 0.350_r8, 0.350_r8 /)
    real(r8), parameter ::     rhdeliques_amode(ntot_amode) = (/ 0.800_r8, 0.800_r8, 0.800_r8, 0.800_r8, 0.800_r8, 0.800_r8, 0.800_r8 /)
#elif ( defined MODAL_AERO_3MODE )
    real(r8), parameter ::     rhcrystal_amode(ntot_amode)  = (/ 0.350_r8, 0.350_r8, 0.350_r8 /)
    real(r8), parameter ::     rhdeliques_amode(ntot_amode) = (/ 0.800_r8, 0.800_r8, 0.800_r8 /)
#endif
    !BSINGH -ENDS
